    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('district_region', models.CharField(blank=True, max_length=50, null=True, verbose_name='Район субъекта')),
                ('city', models.CharField(max_length=50, null=True, verbose_name='Город')),
                ('district_city', models.CharField(max_length=50, null=True, verbose_name='Район города')),
                ...
                ('ower', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='all_adv.subject', verbose_name='Субъект')),
